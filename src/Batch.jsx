...
const Batch_data = [
  ...
  { head: "Digital Marketing/Anne/15 Apr", course: "Digital Marketing", name: "Anne Doe", date: "2025-04-15 To 2025-05-25", startDate: "2025-04-15", endDate: "2025-05-25", time: "4:00 PM - 6:00 PM" },
  ...
  return (
    <>
      <div className='w-11/12 h-lvh ml-6 bg-white border border-slate-300'>
        <input className='rounded-full mt-6 ml-4 leading-8 pl-4 border border-slate-400' placeholder='Enter Here...'
         value={input} 
        ...
        <div className='flex'>
          <div onClick={() => Loader(1)} className='w-32 pl-4 rounded-md bg-white mt-6 ml-4 hover:bg-blue-900 hover:text-white border border-blue-800'>
            <i className="fa-solid fa-calendar-days"></i> Current
          </div>
          <div onClick={() => Loader(2)} className='w-36 pl-4 rounded-md bg-white mt-6 ml-4 hover:bg-blue-900 hover:text-white border border-blue-800'>
            <i className="fa-solid fa-calendar-days"></i> Upcoming
          </div>
          <div onClick={() => Loader(3)} className='w-36 pl-4 rounded-md bg-white mt-6 ml-4 hover:bg-blue-900 hover:text-white border border-blue-900'>
            <i className="fa-solid fa-calendar-days"></i> Completed
          </div>
        </div>
