        ...
        <div className='flex flex-wrap'>
                ...
                {batches.map((batch,i)=>{
                  return(
                    ...
                    <div key={i} className='bg-white w-56 h-56 rounded-lg ml-4 mt-16 border-t-4 border-sky-800 shadow-md shadow-gray-800'>
                    
                      <p className='text-sky-500 decoration-solid pl-2'>{batch.head}</p>
                      ...
                      <button className='w-28 pl-2 rounded-md  mt-6 ml-2 bg-blue-900 text-white'>View Details</button>
